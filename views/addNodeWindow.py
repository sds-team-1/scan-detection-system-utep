...
class Ui_addNode_window(object):
    ...
    def setupAddNode(self, parent_window:QtWidgets.QDialog, selected_scenario_unit:Scenario, create_new_node_function):
        ...
        self.q_row_node_name_label_and_input.addWidget(self.q_label_node_name_label)
        self.q_row_node_name_label_and_input.addWidget(self.q_line_edit_node_name_input)

        # Label that says node type
        ...
        # Combo box that holds the node types
        ...
        #  Row to hold the node type label and combobox
        self.spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.q_row_node_type_label_and_combobox = QtWidgets.QHBoxLayout()
        self.q_row_node_type_label_and_combobox.setObjectName("nodeTypeLayout_addNodeWindow")
        self.q_row_node_type_label_and_combobox.addWidget(self.q_label_node_type_label)
        ...
        # Row to hold the mac address label and input
        self.q_row_node_MAC_address = QtWidgets.QHBoxLayout()
        ...
        # Line edit that holds the ip address input
        ...
        self.q_line_edit_node_IP_Adress_input.setText(f"1.1.{self.ip_counter}.2")

        # Row to hold the ip address label and input
        ...
        # Check box for log net work traffic
        ...
        self.q_row_checkboxes = QtWidgets.QHBoxLayout()
        self.q_row_checkboxes.setObjectName("nodeScannerNodeLayout_addNodeWindow")
        self.q_row_checkboxes.addItem(self.spacerItem1)
        self.q_row_checkboxes.addWidget(self.q_checkbox_web_server_node)
        ...
        self.q_col_main_layout.addLayout(self.q_row_node_type_label_and_combobox)
        self.q_col_main_layout.addLayout(self.q_row_node_name_label_and_input)    
    ...
    def scanner_node_check_box_clicked(self, parent_window, id_counter):
        if self.q_checkbox_scanner_node.isChecked():
            ...
            self.q_col_main_layout.addLayout(self.q_layout_nmap_arguments)
            self.q_col_main_layout.addLayout(self.q_layout_nikto_arguments)
            ...
            self.q_col_main_layout.removeItem(self.q_layout_node_us_pw)
            self.q_col_main_layout.removeItem(self.q_layout_node_scanner_binary)

            self.q_col_main_layout.removeItem(self.q_layout_nmap_arguments)
            self.q_col_main_layout.removeItem(self.q_layout_nikto_arguments)
            self.q_col_main_layout.removeItem(self.q_layout_node_scanner_nikto_nmap)
