...
class Ui_addSetNodes_window(object):
    def setupAddSetNodes(self, parent_window, sds_controller,
        ...
        parent_window.setObjectName("addSetNodes_window")
        parent_window.setEnabled(True)
        parent_window.resize(513, 170)
        parent_window.setMinimumSize(QtCore.QSize(513, 170))
        parent_window.setMaximumSize(QtCore.QSize(513, 170))
        self.AddSetNodesWindowLayout = QtWidgets.QGridLayout(parent_window)
        ...
        self.startingNameLabel_addSetNodesWindow = QtWidgets.QLabel(parent_window)
        ...
        self.startingNameInput_addSetNodesWindow = QtWidgets.QLineEdit(parent_window)
        ...
        self.startingIPLabel_addSetNodesWindow = QtWidgets.QLabel(parent_window)
        ...
        self.startingIPInput_addSetNodesWindow = QtWidgets.QLineEdit(parent_window)
        ...
        self.numberVictimNodesLabel_addSetNodesWindow = QtWidgets.QLabel(parent_window)
        ...
        self.numberVictimNodesSpinbox_addSetNodesWindow = QtWidgets.QSpinBox(parent_window)
        ...
        self.setNodesCreateButton_addSetNodesWindow = QtWidgets.QPushButton(parent_window)
        ...
        self.setNodesCancelButton_addSetNodesWindow = QtWidgets.QPushButton(parent_window)
        ...
        parent_window.setWindowTitle(_translate("addSetNodes_window", "Add Set of Victim Nodes"))
        ...
        self.setNodesCreateButton_addSetNodesWindow.clicked.connect(lambda: self.addSetNodes(
            parent_window, projectsList_captureManagerWindow, nodesList_captureManagerWindow, id_counter, MAC))
        self.setNodesCancelButton_addSetNodesWindow.clicked.connect(parent_window.close)
