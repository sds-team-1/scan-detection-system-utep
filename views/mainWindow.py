...
class Ui_MainWindow(object):
    def setupMainWindowUI(self, MainWindow):
        ...
        self.nodesList_mainWindow.headerItem().setText(0, _translate("MainWindow", "Subnet"))
        self.nodesList_mainWindow.headerItem().setText(1, _translate("MainWindow", "Log Net Traffic"))
        self.nodesList_mainWindow.headerItem().setText(2, _translate("MainWindow", "Type"))
        self.nodesList_mainWindow.headerItem().setText(3, _translate("MainWindow", "Name"))
        self.nodesList_mainWindow.headerItem().setText(4, _translate("MainWindow", "MAC"))
        self.nodesList_mainWindow.headerItem().setText(5, _translate("MainWindow", "IP"))
        #self.nodesList_mainWindow.headerItem().setText(6, _translate("MainWindow", "Port"))
        self.nodesList_mainWindow.headerItem().setText(6, _translate("MainWindow", "Scanner/Victim"))
