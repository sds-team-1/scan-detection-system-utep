...
class Ui_MainWindow(object):
    def setupMainWindowUI(self, MainWindow):
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.projectsList_mainWindow)
        ...
        self.projectsList_mainWindow.topLevelItem(0).setText(0, _translate("MainWindow", "Project 1"))
        self.projectsList_mainWindow.topLevelItem(0).child(0).setText(0, _translate("MainWindow", "Scenario 1"))
        self.projectsList_mainWindow.topLevelItem(0).child(1).setText(0, _translate("MainWindow", "Scenario 2"))
        self.projectsList_mainWindow.topLevelItem(0).child(2).setText(0, _translate("MainWindow", "Scenario 3"))
        self.projectsList_mainWindow.topLevelItem(1).setText(0, _translate("MainWindow", "Project 2"))
        self.projectsList_mainWindow.topLevelItem(1).child(0).setText(0, _translate("MainWindow", "Scenario 1"))
        self.projectsList_mainWindow.topLevelItem(1).child(1).setText(0, _translate("MainWindow", "Scenario 2"))
        self.projectsList_mainWindow.topLevelItem(2).setText(0, _translate("MainWindow", "Project 3"))
        self.projectsList_mainWindow.topLevelItem(2).child(0).setText(0, _translate("MainWindow", "Scenario 1"))
        self.projectsList_mainWindow.topLevelItem(2).child(1).setText(0, _translate("MainWindow", "Scenario 2"))
        self.projectsList_mainWindow.topLevelItem(2).child(2).setText(0, _translate("MainWindow", "Scenario 3"))
        self.projectsList_mainWindow.topLevelItem(2).child(3).setText(0, _translate("MainWindow", "Scenario 4"))
