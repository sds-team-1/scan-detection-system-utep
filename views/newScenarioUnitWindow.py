...
class Ui_newScenarioUnit_window(object):
    def setupNewScenarioUnit(self, newScenarioUnit_window : QtWidgets.QDialog):
        ...
        newScenarioUnit_window.resize(513, 135)
        newScenarioUnit_window.setMinimumSize(QtCore.QSize(513, 135))
        newScenarioUnit_window.setMaximumSize(QtCore.QSize(513, 135))
        ...
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow = QtWidgets.QHBoxLayout()
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.setObjectName("newScenarioUnitNodesLayout_newScenarioUnitWindow")
        self.scannerNodesLabel_newScenarioUnitWindow = QtWidgets.QLabel(newScenarioUnit_window)
        self.scannerNodesLabel_newScenarioUnitWindow.setObjectName("scannerNodesLabel_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.scannerNodesLabel_newScenarioUnitWindow)
        self.scannerNodesSpinbox_newScenarioUnitWindow = QtWidgets.QSpinBox(newScenarioUnit_window)
        self.scannerNodesSpinbox_newScenarioUnitWindow.setObjectName("scannerNodesSpinbox_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.scannerNodesSpinbox_newScenarioUnitWindow)
        self.victimNodesLabel_newScenarioUnitWindow = QtWidgets.QLabel(newScenarioUnit_window)
        self.victimNodesLabel_newScenarioUnitWindow.setObjectName("victimNodesLabel_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.victimNodesLabel_newScenarioUnitWindow)
        self.victimNodesSpinbox_newScenarioUnitWindow = QtWidgets.QSpinBox(newScenarioUnit_window)
        self.victimNodesSpinbox_newScenarioUnitWindow.setObjectName("victimNodesSpinbox_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.victimNodesSpinbox_newScenarioUnitWindow)
        self.setNodesLabel_newScenarioUnitWindow = QtWidgets.QLabel(newScenarioUnit_window)
        self.setNodesLabel_newScenarioUnitWindow.setObjectName("setNodesLabel_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.setNodesLabel_newScenarioUnitWindow)
        self.setNodesSpinbox_newScenarioUnitWindow = QtWidgets.QSpinBox(newScenarioUnit_window)
        self.setNodesSpinbox_newScenarioUnitWindow.setObjectName("setNodesSpinbox_newScenarioUnitWindow")
        self.newScenarioUnitNodesLayout_newScenarioUnitWindow.addWidget(self.setNodesSpinbox_newScenarioUnitWindow)
        self.mainLayout_newScenarioUnitWindow.addLayout(self.newScenarioUnitNodesLayout_newScenarioUnitWindow)
        ...
        self.scannerNodesLabel_newScenarioUnitWindow.setText(_translate("newScenarioUnit_window", "Scanner Nodes:"))
        self.victimNodesLabel_newScenarioUnitWindow.setText(_translate("newScenarioUnit_window", "Victim Nodes:"))
        self.setNodesLabel_newScenarioUnitWindow.setText(_translate("newScenarioUnit_window", "Victim Nodes Sets:"))
